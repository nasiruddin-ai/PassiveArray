...
// Output: store/passive-array-youtube-v<version>.zip
// Only runtime files go in. README, this script, make-assets.js and the store folder stay out.
...
const zipPath = path.join(outDir, "passive-array-youtube-v" + manifest.version + ".zip");
